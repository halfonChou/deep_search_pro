...
def build_doc_tools(sessions:SessionService) -> list:
    ...
    async def generate_markdown(
        ...
        Args:
            ...
            filename: 文件名，如「布洛芬市场分析.md」
            topic:    报告主题，5-15 字，如「布洛芬采购价格趋势」。
                      用于日后检索，请写得具体、含关键实体名。
            summary:  一句话结论，不超过 80 字。写清「查了什么、得出什么」，
                      不要写「本报告分析了……」这类没有信息量的话。
        """
        ...
        try:
            ...
            logger.exception("报告索引写入失败，但是报告已生成: %s",filename)
